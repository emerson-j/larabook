...
class UserRepositoryTest extends \Codeception\TestCase\Test
{
    ...
    */
    ...
    {
        Dummy::times(4)->create('Larabook\Users\User');
        $results = $this->repo->getPaginated(2);
        $this->assertCount(2, $results);
    }

    /** @test */
    public function it_finds_a_users_with_statuses_by_their_username()
    {
        $statuses = Dummy::times(3)->create('Larabook\Statuses\Status');
